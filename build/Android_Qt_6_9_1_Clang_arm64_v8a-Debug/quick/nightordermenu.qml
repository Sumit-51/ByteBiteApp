...
Rectangle {
    ...
    function loadMenuFromFirebase() {
        isLoadingMenu = true
        console.log("📱 USER: Loading Night Order menu from Firebase...")

        var xhr = new XMLHttpRequest()
        var url = "https://firestore.googleapis.com/v1/projects/bytebitelogin/databases/(default)/documents/menu_availability/nightorder/items?key=AIzaSyBSfOQQPEIUDkh16EVPU9j9IGCdhEyx-lE"
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                ...
                if (xhr.status === 200) {
                    try {
                        ...
                        console.log("📦 Processing", documents.length, "menu items for Night Order")
                        ...
                        console.log("🎯 NIGHT ORDER MENU: Showing", availableItems.length, "available items to user")
    ...
    function getDescriptionForItem(itemName) {
        ...
        return "Delicious late-night food item"
    }
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: isLoadingMenu ? "Loading menu, please wait..." : "Late Night Delivery"
                        ...
                        Rectangle {
                            ...
                            RowLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        text: parent.parent.parent.modelData.description || "Delicious late-night food item"
                                        font.family: "SF Pro Text, Segoe UI"
                                        font.pixelSize: 10 * dp
                                        color: "#9ca3af"
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 25 * dp
                    color: totalItems > 0 ? "#6366f1" : "#6b7280"
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            console.log("Placing order with", totalItems, "items from Night Order")
    ...
    Component.onCompleted: {
        console.log("📱 Night Order Menu (Firebase-connected) loaded")
        console.log("👤 User: Sumit-51")
        console.log("🕒 Time: 2025-08-03 10:12:12 UTC")
