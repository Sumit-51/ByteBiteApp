...
Rectangle {
    ...
    function loadMenuFromFirebase() {
        isLoadingMenu = true
        console.log("📱 USER: Loading Pawan menu from Firebase...")

        var xhr = new XMLHttpRequest()
        var url = "https://firestore.googleapis.com/v1/projects/bytebitelogin/databases/(default)/documents/menu_availability/pawan/items?key=AIzaSyBSfOQQPEIUDkh16EVPU9j9IGCdhEyx-lE"
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                ...
                if (xhr.status === 200) {
                    try {
                        ...
                        console.log("📦 Processing", documents.length, "menu items for Pawan")
                        ...
                        console.log("🎯 PAWAN MENU: Showing", availableItems.length, "available items to user")
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: isLoadingMenu ? "Loading menu, please wait..." : "Local Delicacies"
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 25 * dp
                    color: totalItems > 0 ? "#f59e0b" : "#6b7280"
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            console.log("Placing order with", totalItems, "items from Pawan Restaurant")
    ...
    Component.onCompleted: {
        console.log("📱 Pawan Restaurant Menu (Firebase-connected) loaded")
        console.log("👤 User: Sumit-51")
        console.log("🕒 Time: 2025-08-03 10:08:14 UTC")
