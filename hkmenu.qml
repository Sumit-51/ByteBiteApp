...
Rectangle {
    ...
    function loadMenuFromFirebase() {
        isLoadingMenu = true
        console.log("📱 USER: Loading HK menu from Firebase...")

        var xhr = new XMLHttpRequest()
        var url = "https://firestore.googleapis.com/v1/projects/bytebitelogin/databases/(default)/documents/menu_availability/hk/items?key=AIzaSyBSfOQQPEIUDkh16EVPU9j9IGCdhEyx-lE"
            ...
            if (xhr.readyState === XMLHttpRequest.DONE) {
                ...
                if (xhr.status === 200) {
                    try {
                        ...
                        console.log("📦 Processing", documents.length, "menu items for HK")
                        ...
                        console.log("🎯 HK MENU: Showing", availableItems.length, "available items to user")
    ...
    ColumnLayout {
            ...
            RowLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        Text {
                            text: isLoadingMenu ? "Loading menu, please wait..." : "Multi Cuisine"
        ...
        // Mobile Bottom Cart Bar (same as pratima)
        Rectangle {
            Layout.fillWidth: true
    ...
    // Mobile Cart Drawer (same structure as pratima)
    Drawer {
        id: cartDrawer
        width: parent.width
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    radius: 25 * dp
                    color: totalItems > 0 ? "#06b6d4" : "#6b7280"
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            console.log("Placing order with", totalItems, "items from HK Restaurant")
    ...
    Component.onCompleted: {
        console.log("📱 HK Restaurant Menu (Firebase-connected) loaded")
        console.log("👤 User: Sumit-51")
        console.log("🕒 Time: 2025-08-03 10:01:59 UTC")
